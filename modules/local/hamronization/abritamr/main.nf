process HAMRONIZATION_ABRITAMR {
    tag "$meta.id"
    ...
    hamronize \\
        ...
        --reference_database_version ${reference_db_version} > out.temp
    ...
    awk 'BEGIN{FS=OFS="\t"} {sub(/\\..*/,".${meta.bin}",\$1)} 1' out.temp > ${prefix}.abricate.${format}
